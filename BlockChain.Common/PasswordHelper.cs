...
namespace BlockChain.Common
{
    ...
    /// <summary>
    /// 密码相关
    /// 使用了 SecureString ，但这个 SecureString 是否真的安全？无法从内存中读取？  微软文章 https://github.com/dotnet/platform-compat/blob/master/docs/DE0001.md ，说明这个东东虽然提供了一定安全性，但还是有一定风险的
    /// todo: 以后找到替代方法再替换 SecureString ！
    /// </summary>
