...
using BlockChain.ShareToken.Contract.IERC20.ContractDefinition;

namespace BlockChain.ShareToken.Contract.IERC20
{
    public partial class Ierc20Service
    {
        ...
        public Ierc20Service(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
