...
using BlockChain.ShareToken.Contract.DivShareToken.ContractDefinition;

namespace BlockChain.ShareToken.Contract.DivShareToken
{
    public partial class DivShareTokenService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, DivShareTokenDeployment divShareTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<DivShareTokenDeployment>().SendRequestAndWaitForReceiptAsync(divShareTokenDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, DivShareTokenDeployment divShareTokenDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<DivShareTokenDeployment>().SendRequestAsync(divShareTokenDeployment);
        }

        public static async Task<DivShareTokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, DivShareTokenDeployment divShareTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, divShareTokenDeployment, cancellationTokenSource);
            return new DivShareTokenService(web3, receipt.ContractAddress);
        }
        ...
        public DivShareTokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public DivShareTokenService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
