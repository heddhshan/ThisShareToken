...
using BlockChain.ShareToken.Contract.SafeERC20.ContractDefinition;

namespace BlockChain.ShareToken.Contract.SafeERC20
{
    public partial class SafeERC20Service
    {
        ...
        public SafeERC20Service(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
