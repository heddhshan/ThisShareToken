...
{
[Serializable]
public class BasicBusShareTokenFactory_OnAddShareToken
{
    #region 生成该数据实体的SQL语句
    public const string SQL = @"Select Top(1) * From BasicBusShareTokenFactory_OnAddShareToken";
    #endregion
    ...
    public BasicBusShareTokenFactory_OnAddShareToken()
    {
    }

    
    public BasicBusShareTokenFactory_OnAddShareToken(System.Int32 AChainId,System.String AContractAddress,System.String ATransactionHash)
    {
        _ChainId = AChainId;
    ...
    public static BasicBusShareTokenFactory_OnAddShareToken DataRow2Object(System.Data.DataRow dr)
    {
        if (dr == null)
        {
            return null;
        }
        BasicBusShareTokenFactory_OnAddShareToken Obj = new BasicBusShareTokenFactory_OnAddShareToken();
...
public BasicBusShareTokenFactory_OnAddShareToken Copy()
{
    BasicBusShareTokenFactory_OnAddShareToken obj = new BasicBusShareTokenFactory_OnAddShareToken();
    ...
    return obj;
        ...
        public static List<BasicBusShareTokenFactory_OnAddShareToken> DataTable2List(System.Data.DataTable dt)
        {
            List<BasicBusShareTokenFactory_OnAddShareToken> result = new List<BasicBusShareTokenFactory_OnAddShareToken>();
            foreach (System.Data.DataRow dr in dt.Rows)
            {
                result.Add(BasicBusShareTokenFactory_OnAddShareToken.DataRow2Object(dr));
            }
            return result;
        }
        ...
        private static BasicBusShareTokenFactory_OnAddShareToken _NullObject = null;

        public static  BasicBusShareTokenFactory_OnAddShareToken NullObject
        {
            get
            {
                if (_NullObject == null)
                {
                    _NullObject = new BasicBusShareTokenFactory_OnAddShareToken();
                }
                return _NullObject;
            }
        }
