...
//
//  本文件由代码工具自动生成。如非必要请不要修改。2023/5/17 16:09:33
//
using System;
using System.Data;
...
public class WalletHelper_OnDeployContract
{
    ...
    private System.Double __amount;
    public System.Double _amount
    {
        get {return __amount;}
        set {__amount = value;}
    }
    ...
    public WalletHelper_OnDeployContract(System.Int32 AChainId,System.String AContractAddress,System.String ATransactionHash)
    {
        _ChainId = AChainId;
    ...
    public static WalletHelper_OnDeployContract DataRow2Object(System.Data.DataRow dr)
    {
        ...
        Obj._amount = dr["_amount"] == DBNull.Value ? 0 : (System.Double)(dr["_amount"]);
...
if (string.IsNullOrEmpty(this._amount_Text) || string.IsNullOrEmpty(this._amount_Text.Trim())) throw new Exception("_amount_Text要求不空。");
}
