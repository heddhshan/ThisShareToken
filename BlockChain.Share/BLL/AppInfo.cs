...
WHERE   (ContractAddress = @ContractAddress) AND (_AppId = @AppId) AND (_PlatformId = @PlatformId) AND 
                (_eventId < @_eventId) AND (ChainId = @ChainId)
";
        ...
        public static async Task<bool> SynOnPublishAppVersion()
        {
            ...
            try
            {
                ...
                foreach (var ev in ate)
                {
                    ...
                    var model = DAL.AppInfo_OnPublishAppVersion.GetModel(Share.ShareParam.DbConStr, chainid, contractAddress, EventId);
                    if (model == null)
                    {
        ...
        public static async Task<bool> SynOnPublishAppDownload()
        {
            ...
            try
            {
                ...
                foreach (var ev in ate)
                {
                    ...
                    var model = DAL.AppInfo_OnPublishAppDownload.GetModel(Share.ShareParam.DbConStr, chainid, contractAddress, EventId);
                    if (model == null)
                    {
        ...
        public static int DeleteAllAppInfo()
        {
            ...
            string sql = @"
DELETE FROM AppInfo_OnPublishAppVersion WHERE   (ChainId = @ChainId);
DELETE FROM AppInfo_OnPublishAppDownload WHERE   (ChainId = @ChainId);
DELETE FROM ContEventBlockNum WHERE   (EventName = 'OnPublishAppDownload') OR (EventName = 'OnPublishAppVersion') and   (ChainId = @ChainId);
";
...
";
        ...
        public async static Task<bool> SynOnPublishNotice()
        {
            ...
            try
            {
                ...
                {
                    var num = (ulong)ev.Log.BlockNumber.Value;
                    var model = DAL.Appinfo_OnPublishNotice.GetModel(Share.ShareParam.DbConStr, chainid, ev.Log.TransactionHash);
                    if (model == null)
                    {
...
WHERE   (ContractAddress = @ContractAddress) AND (_appId = @AppId) and   (ChainId = @ChainId)
