...
{
    NewID = 0;
    string sql = @"insert into TransactionReceipt (ChainId,TransactionHash,CreateTime,UserMethod,UserFrom,UserRemark,TransactionIndex,GotReceipt,BlockHash,BlockNumber,CumulativeGasUsed,GasUsed,GasPrice,ContractAddress,Status,Logs,HasErrors,ResultTime,Canceled) values (@ChainId,@TransactionHash,@CreateTime,@UserMethod,@UserFrom,@UserRemark,@TransactionIndex,@GotReceipt,@BlockHash,@BlockNumber,@CumulativeGasUsed,@GasUsed,@GasPrice,@ContractAddress,@Status,@Logs,@HasErrors,@ResultTime,@Canceled); SELECT SCOPE_IDENTITY() AS NewID;";
...
public static int Delete(string conStr, System.Int32 ChainId,System.Int32 Id)
{
    string sql = @"Delete From TransactionReceipt Where ChainId = @ChainId and Id = @Id";
    SqlConnection cn = new SqlConnection(conStr);
    SqlCommand cm = new SqlCommand();
    cm.Connection = cn;
    cm.CommandType = System.Data.CommandType.Text;
...
public static Model.TransactionReceipt GetModel(string conStr, System.Int32 ChainId, System.Int32 Id)
{
    string sql = @"select * from TransactionReceipt Where ChainId = @ChainId and Id = @Id ";
...
public static bool Exist(string conStr, System.Int32 ChainId, System.Int32 Id)
{
    string sql = @"Select Count(*) From TransactionReceipt Where ChainId = @ChainId and Id = @Id ";
    SqlConnection cn = new SqlConnection(conStr);
    SqlCommand cm = new SqlCommand();
    cm.Connection = cn;
    cm.CommandType = System.Data.CommandType.Text;
